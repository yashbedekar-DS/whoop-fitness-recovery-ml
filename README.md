...
Or open and run the notebooks in `notebook/` from `RQ1_notebook.ipynb` to `RQ7_notebook.ipynb`.

## Generated Outputs

Tables are saved in `outputs/tables/`. Figures are saved in `outputs/figures/images/` and `outputs/figures/pdf/`.
...
- Complete code: `whoop_assignment_pipeline.py` and `notebook/RQ1_notebook.ipynb` to `notebook/RQ7_notebook.ipynb`
